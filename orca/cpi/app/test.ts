...
async function main() {
  ...
  const devSOL = {symbol: "SOL", mint: new anchor.web3.PublicKey("So11111111111111111111111111111111111111112"),  decimals: 9};
  const devUSDC = {symbol: "USDC", mint: new anchor.web3.PublicKey("EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v"), decimals: 6};
